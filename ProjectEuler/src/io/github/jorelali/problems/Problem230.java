...
public class Problem230 extends RT {

	/*
	 * https://projecteuler.net/problem=230 For any two strings of digits, A and
	 * B, we define FA,B to be the sequence (A,B,AB,BAB,ABBAB,...) in which each
